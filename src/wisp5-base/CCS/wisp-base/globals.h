...
typedef struct {
    ...
    uint16_t    wordPtr;                    /* for Rd/Wr, this will hold wordPtr parsed from cmd when hook is called            */
    ...
    uint16_t    controlMessage;             /* for BlockWrite with MEM bank = 00, this will contain the message payload         */
    uint16_t    bitCount;
